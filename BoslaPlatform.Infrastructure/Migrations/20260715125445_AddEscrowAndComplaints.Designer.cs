...
namespace BoslaPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260715125445_AddEscrowAndComplaints")]
    partial class AddEscrowAndComplaints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoslaPlatform.Domain.Entities.Payments.PaymentComplaint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BoslaPlatform.Domain.Entities.System.RecordingAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BoslaPlatform.Domain.Models.Video.VideoSession", b =>
                {
                    ...
                    b.Property<string>("RecordingFailureReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<DateTime?>("S3UploadedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BoslaPlatform.Domain.Entities.Payments.PaymentComplaint", b =>
                {
                    b.HasOne("BoslaPlatform.Domain.Models.Booking.Payment", "Payment")
                        .WithOne("Complaint")
                        .HasForeignKey("BoslaPlatform.Domain.Entities.Payments.PaymentComplaint", "PaymentId")
            ...
            modelBuilder.Entity("BoslaPlatform.Domain.Entities.System.RecordingAuditLog", b =>
                {
                    b.HasOne("BoslaPlatform.Domain.Models.Video.VideoSession", null)
                        .WithMany()
